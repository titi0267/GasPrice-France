...
const autoCompleteAdress = async (adress) => {
    const autoCompleteResult = await (0, request_services_1.default)(`https://api.openrouteservice.org/geocode/autocomplete?api_key=${env_1.default.openRouteServiceApiKey}&text=${adress}&boundary.country=FR`, "GET", "OpenRouteService");
    const refineResult = [];
    let maxResult = 0;
